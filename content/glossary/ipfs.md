...
The InterPlanetary File System (IPFS) is a distributed system for storing and accessing files. It builds upon a [content-addressable](contentaddressing), distributed data structure and a peer-to-peer protocol for sharing content without centralized structures. 
...
IPFS is a building block of higher-level concepts including [IPLD](ipld).
